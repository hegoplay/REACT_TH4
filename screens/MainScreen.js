  ...
  useLayoutEffect(() => {
    const getData = async () => {
      let res = await axios.get(
        "https://671dfa4a1dfc42991980dfe8.mockapi.io/location"
      );
      setCurCategory(res.data);
      res = await axios.get(
        "https://670de03b073307b4ee44bda5.mockapi.io/api/v1/photos"
      );
      ...
      <View style={styles.midContainer}>
        <ScrollView>
          ...
          <FlatList
            ...
            horizontal={true}
            renderItem={({ item }) => (
              <Image source={{ uri: item.image }} style={styles.smallImgSize} />
            )}
          />
          <View
            style={{
          ...
          <FlatList
            ...
            horizontal={true}
            renderItem={({ item }) => (
              <Image source={{ uri: item.image }} style={styles.bigImgSize} />
            )}
          />
        </ScrollView>
      </View>
